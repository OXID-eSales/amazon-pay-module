...
class UserComponentTest extends TestCase
{
    ...
    private const USER_ID = 'amazonlogintestuser';

    protected function setUp(): void
    {
        parent::setUp();

        $this->setMode(Constants::LOGIN_BY_EMAIL_OFF);
        $this->removeUser();
    }
    ...
    public function testGuestAccountIsSignedInInGuestOnlyMode(): void
    {
        ...
        $this->setMode(Constants::LOGIN_BY_EMAIL_GUEST_ONLY);
        $this->provideSessionChallenge();
    ...
    public function testPasswordProtectedAccountIsSignedInInAllAccountsMode(): void
    {
        ...
        $this->setMode(Constants::LOGIN_BY_EMAIL_ALL);
        $this->provideSessionChallenge();
    ...
    private function setMode(string $mode): void
    {
        ...
        $config->setLoginByEMailMode($mode);
    }
