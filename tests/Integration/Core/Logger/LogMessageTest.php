...
namespace OxidSolutionCatalysts\AmazonPay\Tests\Integration\Core\Logger;

use OxidSolutionCatalysts\AmazonPay\Core\Logger\LogMessage;
use OxidEsales\TestingLibrary\UnitTestCase;

class LogMessageTest extends \OxidSolutionCatalysts\AmazonPay\Tests\Integration\Core\AmazonTestCase
{
    /** @var LogMessage */
    private $logMessage;
