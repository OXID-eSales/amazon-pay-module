 ...
 */
class RefundMailServiceTest extends UnitTestCase
{
    ...
    {
        $this->setConfigParam('amazonPayRefundMailRecipient', Constants::MAIL_RECIPIENT_BOTH);
    ...
    {
        $this->setConfigParam('amazonPayRefundMailRecipient', Constants::MAIL_RECIPIENT_NONE);
        $this->setConfigParam('amazonPayCancelMailRecipient', Constants::MAIL_RECIPIENT_NONE);
