...
class AddressTest extends UnitTestCase
{
     ...
     * @param string $value
     */
    public function testParseAddress(array $address, $key, $value)
    {
     ...
     * @param string $value
     */
    public function testMapBillingAddressToDb(array $address, $key, $value)
    {
     ...
     * @param string $value
     */
    public function testMapShippingAddressToDb(array $address, $key, $value)
    {
     ...
     * @param string $value
     */
    public function testMapAddressToView(array $address, $key, $value)
    {
