...
class AddressTest extends UnitTestCase
{
     ...
     * @param string $value
     */
    public function testParseAddress($address, $key, $value)
    {
     ...
     * @param string $value
     */
    public function testMapBillingAddressToDb($address, $key, $value)
    {
     ...
     * @param string $value
     */
    public function testMapShippingAddressToDb($address, $key, $value)
    {
     ...
     * @param string $value
     */
    public function testMapAddressToView($address, $key, $value)
    {
