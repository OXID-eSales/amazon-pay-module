...
$aLang = [
    ...
    'OXPS_AMAZONPAY_PUBKEY'                  => 'Öffentlicher Schlüssel',
    'HELP_OXPS_AMAZONPAY_PUBKEY'             => 'Ihr öffentlicher Schlüssel für die Integration.',
    ...
    'OXPS_AMAZONPAY_CAPTYPE'                 => 'Zeitpunkt Geldeinzug',
    'OXPS_AMAZONPAY_CAPTYPE_ONE_STEP'        => 'Einstufig',
    'OXPS_AMAZONPAY_CAPTYPE_TWO_STEP'        => 'Zweistufig',
    'HELP_OXPS_AMAZONPAY_CAPTYPE'            => 'Bei "einstufig" wird das Geld vom Kunden sofort mit der Bestellung eingezogen. Bei "zweistufig" wird das Geld vom Kunden erst nach der Lieferung der Ware eingezogen.',
    'OXPS_AMAZONPAY_EXCLUDED'                => 'AmazonPay ausschließen',
    'OXPS_AMAZONPAY_CARRIER_CODE'            => 'Amazon Lieferdienstleister',
    'OXPS_AMAZONPAY_IPN_HISTORY'             => 'AmazonPay Benachrichtigungs Historie (IPN)',
    'OXPS_AMAZONPAY_TRANSACTION_HISTORY'     => 'AmazonPay Transaktions Historie',
    'OXPS_AMAZONPAY_DATE'                    => 'Datum',
    'OXPS_AMAZONPAY_REFERENCE'               => 'Referenz',
    'OXPS_AMAZONPAY_RESULT'                  => 'Ergebnis',
    'OXPS_AMAZONPAY_PAYMENT_WHEN_SHIPPING'   => 'Geldeinzug durch AmazonPay wenn Lieferung erfolgt ist',
    'OXPS_AMAZONPAY_PAYMENT_WAS_SHIPPING'    => 'Der Geldeinzug durch AmazonPay ist nach Lieferung erfolgt',
    'OXPS_AMAZONPAY_PAYMENT_DURING_CHECKOUT' => 'Der Geldeinzug durch AmazonPay ist während der Bestellung erfolgt'
];
