[{if 'oxuser__oxsal'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxsal">[{oxmultilang ident="TITLE"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxfname'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxfname">[{oxmultilang ident="FIRST_NAME"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxlname'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxlname">[{oxmultilang ident="LAST_NAME"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxcompany'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxcompany">[{oxmultilang ident="COMPANY"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxaddinfo'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        ...
        <label [{if $_address_addinfo_tooltip}]title="[{$_address_addinfo_tooltip}]"[{/if}] class="col-xs-3 req[{if $_address_addinfo_tooltip}] tooltip[{/if}]" for="invadr_oxuser__oxaddinfo">[{oxmultilang ident="ADDITIONAL_INFO"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxstreet'|array_key_exists:$missingRequiredBillingFields || 'oxuser__oxstreetno'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-12 req" for="invadr_oxuser__oxstreet">[{oxmultilang ident="STREET_AND_STREETNO"}]</label>
        <div class="col-xs-8">
...
[{if 'oxuser__oxzip'|array_key_exists:$missingRequiredBillingFields || 'oxuser__oxcity'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxzip">[{oxmultilang ident="POSTAL_CODE_AND_CITY"}]</label>
        <div class="col-xs-5">
...
[{if 'oxuser__oxustid'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxustid">[{oxmultilang ident="VAT_ID_NUMBER"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxcountryid'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invCountrySelect">[{oxmultilang ident="COUNTRY"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxfon'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxfon">[{oxmultilang ident="PHONE"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxfax'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxfax">[{oxmultilang ident="FAX"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxmobfon'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxmobfon">[{oxmultilang ident="CELLUAR_PHONE"}]</label>
        <div class="col-xs-9">
...
[{if 'oxuser__oxprivfon'|array_key_exists:$missingRequiredBillingFields}]
    <div class="form-group row text-danger">
        <label class="col-xs-3 req" for="invadr_oxuser__oxprivfon">[{oxmultilang ident="PERSONAL_PHONE"}]</label>
        <div class="col-xs-9">
