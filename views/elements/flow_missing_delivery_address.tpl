[{block name="flow_missing_delivery_address"}]
    <div id="missing_delivery_address">
        [{block name="flow_missing_delivery_address_note"}]
        ...
        [{/block}]
        [{block name="flow_missing_delivery_address_fields"}]
            [{if 'oxaddress__oxsal'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxsal">[{oxmultilang ident="TITLE"}]</label>
                    <div class="col-xs-9">
            ...
            [{if 'oxaddress__oxfname'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxfname">[{oxmultilang ident="FIRST_NAME"}]</label>
                    <div class="col-xs-9">
            ...
            [{if 'oxaddress__oxlname'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxlname">[{oxmultilang ident="LAST_NAME"}]</label>
                    <div class="col-xs-9">
            ...
            [{if 'oxaddress__oxcompany'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxcompany">[{oxmultilang ident="COMPANY"}]</label>
                    <div class="col-xs-9">
            ...
            [{if 'oxaddress__oxaddinfo'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    ...
                    <label [{if $_address_addinfo_tooltip}]title="[{$_address_addinfo_tooltip}]"[{/if}] class="col-xs-3 req[{if $_address_addinfo_tooltip}] tooltip[{/if}]" for="missing_amazon_deladr_oxaddress__oxaddinfo">[{oxmultilang ident="ADDITIONAL_INFO"}]</label>
                    <div class="col-xs-9">
            ...
            [{/if}]
            [{if 'oxaddress__oxstreet'|array_key_exists:$missingRequiredDeliveryFields || 'oxaddress__oxstreetnr'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-12 req" for="missing_amazon_deladr_oxaddress__oxstreet">[{oxmultilang ident="STREET_AND_STREETNO"}]</label>
                    <div class="col-xs-8">
            ...
            [{if 'oxaddress__oxzip'|array_key_exists:$missingRequiredDeliveryFields || 'oxaddress__oxcity'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxzip">[{oxmultilang ident="POSTAL_CODE_AND_CITY"}]</label>
                    <div class="col-xs-5">
            ...
            [{if 'oxaddress__oxcountryid'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxcountryid">[{oxmultilang ident="COUNTRY"}]</label>
                    <div class="col-xs-9">
                ...
                <div class="form-group row">
                    <label class="col-xs-3" for="[{$oxcmp_user->oxaddress__oxstateid->value}]">[{oxmultilang ident="DD_USER_LABEL_STATE" suffix="COLON"}]</label>
                    <div class="col-xs-9">
            ...
            [{if 'oxaddress__oxfon'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxfon">[{oxmultilang ident="PHONE"}]</label>
                    <div class="col-xs-9">
            ...
            [{if 'oxaddress__oxfax'|array_key_exists:$missingRequiredDeliveryFields}]
                <div class="form-group row text-danger">
                    <label class="col-xs-3 req" for="missing_amazon_deladr_oxaddress__oxfax">[{oxmultilang ident="FAX"}]</label>
                    <div class="col-xs-9">
